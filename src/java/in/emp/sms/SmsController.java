...
public class SmsController {
    ...
    public void sendSMS(SmsDTO smsdto, String templateId, List lstcredential) throws Exception {
        ...
        if (smsdto != null) {
            ...
            if (lstcredential.get(0).toString() == ApplicationConstants.OTP_URL) {//username for otp 
                ...
                smsData = createSmsStringTemplateTest(smsdtoNew, smsdto.getMobileNumber(), smsdto.getLstParams());
    ...
    private String createSmsStringTemplateTest(SmsDTO smsdto, String mobileNumber, List lstParams) {
        String smsData = "";
        int counter = 0;
        String message = "";
        ...
        if (smsdto != null) {
            ...
            jsonSmsData.put("MOBILE_NUMBER", "9028866929");
            jsonSmsData.put("OFFICE_CODE", "000");
            jsonSmsData.put("OFFICE_TYPE", "000");
            jsonSmsData.put("SCHEDULED_SUBMISSION_DT", "20230420123900");
    ...
    public void sendSMS(String urlString, String smsData, SmsDTO smsdto) throws Exception {
