...
public class GetInstallPointTypesQueryHelper implements QueryHelper
{
	private static Logger logger = Logger.getLogger(GetInstallPointTypesQueryHelper.class);
	
	
	/**
	 * @public Constructor GetDeviceTypesQueryHelper()
	 */
	public GetInstallPointTypesQueryHelper()
	{
	...
	public Object getDataObject(ResultSet results) throws Exception 
	{
		...
		{
			logger.log(Level.ERROR, "GetInstallPointTypesQueryHelper :: getDataObject() :: Exception :: "+ex);
			throw ex;
		}
	...
	public ResultSet getQueryResults(Connection connection) throws Exception 
	{
		...
		try 
		{
			...
			logger.log(Level.INFO, "GetInstallPointTypesQueryHelper ::: getQueryResults() :: SQL :: "+sql.toString());
		...
		{
			logger.log(Level.ERROR, "GetInstallPointTypesQueryHelper :: getQueryResults() :: Exception :: " + ex);
			//ex.printStackTrace();
			throw ex;
		}		
		return rs;
