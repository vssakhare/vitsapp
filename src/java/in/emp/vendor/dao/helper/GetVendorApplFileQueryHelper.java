 ...
 * @author Prajakta
 */
public class GetVendorApplFileQueryHelper implements QueryHelper {
    ...
    public GetVendorApplFileQueryHelper(VendorApplFileBean vendorapplFileBeanObj) {
        this.vendorapplFileBeanObj = vendorapplFileBeanObj;
    }

    public GetVendorApplFileQueryHelper(VendorApplFilePrezData vendorapplFilePrezDataObj) {
    ...
    public Object getDataObject(ResultSet results) throws Exception {
        ...
        try {
            logger.log(Level.INFO, "GetVendorApplFileQueryHelper ::: getQueryResults() :: method called ::");
