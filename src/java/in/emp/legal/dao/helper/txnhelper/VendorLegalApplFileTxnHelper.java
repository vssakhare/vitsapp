 ...
 * @author Rikma Rai
 */
public class VendorLegalApplFileTxnHelper implements TxnHelper{
     ...
     */
    public VendorLegalApplFileTxnHelper(VendorApplFileBean vendorapplFileBeanObj) {
     ...
     */
    public VendorLegalApplFileTxnHelper(VendorApplFilePrezData vendorapplFilePrezDataObj) {
    ...
    public Object createObject(Connection conn) throws Exception {
        ...
        String fileId = "";
        try {
            logger.log(Level.INFO, "VendorLegalApplFileTxnHelper ::: createObject() :: method called ::");
            ...
            sql.append(" INSERT INTO XXMIS_ERP_LEGAL_INVOICE_FILES ");
            ...
            logger.log(Level.ERROR, "VendorLegalApplFileTxnHelper ::: createObject() :: Exception :: " + ex);
    ...
    public void updateObject(Connection conn) throws Exception {
     PreparedStatement statement = null;
        StringBuilder sql = new StringBuilder();
             int count = 0;
        try {
            logger.log(Level.INFO, "VendorLegalApplFileTxnHelper ::: updateObject() :: method called ::");
 sql.append(" UPDATE XXMIS_ERP_LEGAL_INVOICE_FILES ");
            sql.append("  SET PATH = ?  WHERE APPL_ID = ? "); // 1 here
            sql.append(" AND ID = ? "); // 2 till here
            sql.append(" AND USER_ID_CREATED = ? "); // 3 till here
 logger.log(Level.INFO, "VendorLegalApplFileTxnHelper :: UPDATEObject() :: SQL :: " + sql.toString());
          
            statement = conn.prepareStatement(sql.toString());
            System.out.println("vendorapplFileBeanObj.getPath()::"+vendorapplFileBeanObj.getPath());
           ...
           conn.rollback();
            logger.log(Level.ERROR, "VendorLegalApplFileTxnHelper ::: updateObject() :: Exception :: " + ex);
            ex.printStackTrace();
            throw ex;
    ...
    public void deleteObject(Connection conn) throws Exception {
        ...
        StringBuilder sql = new StringBuilder();
        try {
            logger.log(Level.INFO, "VendorLegalApplFileTxnHelper ::: deleteObject() :: method called ::");

            sql.append(" DELETE FROM XXMIS_ERP_LEGAL_INVOICE_FILES ");
            ...
            logger.log(Level.ERROR, "VendorLegalApplFileTxnHelper ::: deleteObject() :: Exception :: " + ex);
            conn.rollback();
            throw ex;
        }
    }//deleteObject() ends
