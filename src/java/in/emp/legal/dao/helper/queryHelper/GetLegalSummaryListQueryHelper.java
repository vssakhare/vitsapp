...
public class GetLegalSummaryListQueryHelper implements QueryHelper {
    ...
    public Object getDataObject(ResultSet results) throws Exception {
        ...
        try {
            ...
            legalInvoiceInputBeanObj.setZone(results.getString("ZONE"));
            legalInvoiceInputBeanObj.setCircle(results.getString("CIRCLE"));
            legalInvoiceInputBeanObj.setDivision(results.getString("DIVISION"));
    ...
    public ResultSet getQueryResults(Connection connection) throws Exception {
        ...
        try {
            ...
            if (legalInvoiceInputBeanObj.getUserType().equals("Emp")) {
                ...
                sql.append("			AND SAVE_FLAG in ('Accepted')  )x 																	    ");
                sql.append("			LEFT JOIN zhrt_legal_fee zf ON to_number(x.vendor_number) = zf.vendor AND x.case_ref_no = zf.caserefno																						    ");
