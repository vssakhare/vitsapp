...
{
	btn = document.getElementsByName("searchSelect");
	var cnt = -1;
	...
	if (cnt > -1) 
	{
		if(btn[cnt].value == 'MPD')
			window.location="tools_search_results_page.html";
		else if(btn[cnt].value == 'PKB')
			window.location="tools_search_results_page_pkb.html";
	}
	else 
	{
		alert("MPD = Europe and PKB = rest of world excluding Europe");
	}
}
