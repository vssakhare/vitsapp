...
<%
    ...
    if (request.getSession().getAttribute(ApplicationConstants.VENDOR_FORWARD_TO_OFFICECODE_SESSION_DATA) != null) {
        POBeanObj=(POBean)request.getSession().getAttribute(ApplicationConstants.VENDOR_FORWARD_TO_OFFICECODE_SESSION_DATA);
   Forward_to_office_code=POBeanObj.getOfficeode();
    }
...
String FORWARD_AT_DESC="";
    ...
    if (vendorInputBean != null) {
        ...
        if (!ApplicationUtils.isBlank(vendorInputBean.getLocationId())) {//location id is set to logged in employee office  code 
        ...
        if (!ApplicationUtils.isBlank(vendorInputBean.getDispVendorNumber())) {
            VendorNum = vendorInputBean.getDispVendorNumber();
        }
        ...
        if ((vendorInputBean.getForwardToPlant() != null)) {
            FORWARD_AT_PLANT = vendorInputBean.getForwardToPlant();
        }
...
<html xmlns="http://www.w3.org/1999/xhtml">
            ...
            <div id="page-wrapper" >
                <div id="page-inner" style="min-height:500px;">
                  ...
                  <!-- <input type="hidden" name ="poNumber" id="poNumber" value="<%=PONumber%>">-->
                    ...
                    <input type="hidden" name="redir" id="redir" value="<%=ApplicationConstants.UIACTION_GET_VENDORINPUT_LIST%>"/>
                    <input type="hidden" name="rem" id="rem" value="<%=ApplicationConstants.UIACTION_GET_VENDOR_INPUT_FORM%>"/>
                        ...
                        <div class="content_container_sub">  <!-- Start of  content_container_sub div  -->
                            ...
                            <table class="table" style="width:100%" id="tblone" border="0" cellspacing="0" cellpadding="1"   >
                               ...
                               <tr>
                                  ...
                                  <!--   <tr>
                                    ...
                                    <%  if (flag == 2) {%>
                                    <td class="text-right h5" ><fmt:message key='Select Module Type'/>.</td> 
                                    <td><select id="Module" name="txtModule" class="form-control text-right" value = "<%=Module_dtl%>" style="width: 500px " onchange="SelectModuleButton();"  >
                                            <option value="">- <fmt:message key='Select'/> -</option>                                              
                                            <option value="PM">Procurement/Works</option>
                                            <option value="PS">Project System</option>


                                        </select></td>
                                        <%} else {%>
                                    <td class="text-right h5" ><fmt:message key='Select Module Type'/>.</td>
                                <input type="hidden" name="Module" id="Module" style="width: 500px" value ="<%=Module_dtl%>"  class="form-control text-left" readonly="true"  >
                                <td><input type="text" name="Moduledtl" id="Moduledtl" style="width: 500px" value ="<%=Module_dtl%>"  class="form-control text-left" readonly="true"  ></td>
                               ...
                               <!-- <tr>
                                    ...
                                    <%	if (UserType.equals("Vendor") && (Status == "")) {%>
                                    <td class="text-right h5" ><label id="mydrop_down_label"><fmt:message key='PO Number'/></label>.</td>
                                    <%
                        } else {%>
                                    <% 	if (selectedmodule.equals("PS")) {%>
                                    <td class="text-right h5" ><label id="mydrop_down_label"><fmt:message key='Project Id'/></label>.</td>
                                    ...
                                    <td id="myDropdown">
                                        <div class="autocomplete" id="autolist" style="width:500px;">
                                            <input autocomplete="off" type="hidden" id="selectedTxtPONumber"/>
                                            <%if (UserType.equals("Vendor")) {
                                if (selectedmodule.equals("PS")) {%>
                                                   <input autocomplete="off" type="text" name="txtPONumber" id="txtPONumber" style="width: 100%;display:none;"  value ="<%=PONumber%>" class="form-control" title="Type and search or use space-bar " placeholder=<fmt:message key='"Type and search or use space-bar"'/> onkeypress="getPOSearchList();" <% if (flag == 2) {
                                    } else {
                                        out.print("disabled='true'");
                                    }%>  />
                                            <input autocomplete="off" type="text" name="txtPROJNumber" id="txtPROJNumber" style="width: 100%;" value ="<%=projectid%>" class="form-control" title="Type and search or use space-bar proj" placeholder=<fmt:message key='"Type and search or use space-bar"'/> onkeypress="getPROJSearchList();"   <% if (flag == 2) {
                                                } else {
                                                    out.print("disabled='true'");
                                                }%> />						
                                            <%} else {%>
                                            <input autocomplete="off" type="text" name="txtPONumber" id="txtPONumber" style="width: 72%;float:left"  value ="<%=PONumber%>" class="form-control" title="Type and search or use space-bar " placeholder=<fmt:message key='"Type and search or use space-bar"'/> onkeypress="getPOSearchList();"
                                            ...
                                            <button type="button" class="button_allign" style="height:34px;width:28%" id="myBtn"  disabled onClick="getPOLineDetails()">Show PO Details</button> 
                                                   <input autocomplete="off" type="text" name="txtPROJNumber" id="txtPROJNumber" style="width: 100%;display:none" value ="<%=ProjDesc%>" class="form-control" title="Type and search or use space-bar proj" placeholder=<fmt:message key='"Type and search or use space-bar"'/> onkeypress="getPROJSearchList();" <% if (flag == 2) {
                                                                    } else {
                                                                        out.print("disabled='true'");
                                                                    }%>  /> 						
                                            <%}
                                            ...
                                            <% if (UserType.equals("Emp")) {%>
                                            <% 	if (selectedmodule.equals("PS")) {%><input type="text" name="txtPROJNumber" id="txtPROJNumber" style="width: 100%" value ="<%=ProjDesc%>"  class="form-control" readonly="true" >
                                            <%} else {%>
                                            <input type="text" name="txtPONumber" id="txtPONumber" style="width: 72%;float:left" value ="<%=PONumber%>" class="form-control" readonly="true" >
                                            <button type="button" class="button_allign" style="height:34px;width:28%" id="myBtn"   onClick="getPOLineDetails()">Show PO Details</button> 
                                            <% }
                                                       }%>
                                        </div>        
                                ...
                                <!--   <tr>
                                       <td colspan="5" id="projcheckbox" style="text-align:center;display: none;">
                                   <span style="padding:0 20px;"><input type="checkbox" name="Material"  value="Material"><label  class="checkbox-inline">Material PO</label></span>
                                  <span style="padding:0 20px;"><input type="checkbox" name="Services"  value="Services"><label  class="checkbox-inline">Services PO</label> </span>
                                  <span style="padding:0 20px;"><input type="checkbox" name="Centages"  value="Centages"><label  class="checkbox-inline">Centages PO</label></span>
                                       </td>
                                   </tr>-->
                            ...
                            <table class="table" border="0" cellspacing="0" cellpadding="2" id="table_content"> <!-- Start of  table_content table  -->
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="form-control text-right" name="txtVNum" id="txtVNum" value="<%=VendorNum%>" style="width: 100%" readonly="true" /> 
                                    </td>

                                    <td class="text-right h5" colspan="2"><fmt:message key='Vendor Name'/></td>
                                    <td > 
                                        <input name="txtVName" id="txtVName" type="text" class="form-control" size="20" style="width: 100%" value="<%=VendorName%>"  readonly="true" /> 
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%"> 
                                        <% if (flag == 2) {%>
                                             <input name="" id="txtVendorInvoiceDate" type="text" readonly size="20" class="datefield" value="<%=VendorInvoiceDt%>" maxlength="15" 
                                            <%  } else {%>
  ...
  <td colspan ="2" width="10%" class="text-right h5">Invoice Inward Date </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="form-control text-right" name="txtInwardNum" id="txtInwardNum" value="<%=InwardNum%>" placeholder=<fmt:message key='"Max length is 10"'/> maxlength="10"  style="width: 100%"
                                               <% if (UserType.equals("Emp") && (Status.equals("Submitted")||Status.equals("Forwarded"))) {
                                                   } else {
                                                       out.print("disabled='true'");
                                                   }%>
                                ...
                                <tr> 
                                    ...
                                    <td ><select class ="form-control text-right" style="width: 100%" id="SubmitAtPlant" name="SubmitAtPlant" value="<%=SUBMIT_AT_LOCATION%>"   >
                                            <option value="">- <fmt:message key='Select'/> -</option>                                              
                                ...
                                <tr>
                                          ...
                                          <!--user is employee and status is submitted-->    
                                         <%   if (UserType.equals("Emp")&&(!selectedmodule.equals("PS"))){ //purchasing group office  code matches with logged in office code 
                                        if (Status.equals("Submitted") && (LocationId.equals(Office_Code) || LocationId.equals(ApplicationConstants.HO_OFFICE_CODE))) {%>

                                    <td  class="text-right h5"><fmt:message key='Forward To'/></td>
                                                     <td ><select class ="form-control text-right selectoption" style="width: 100%" id="forwardAtPlant" name="forwardAtPlant"  class="form-control text-right" style="width: 400px ;"  >
                                            <option value="">- <fmt:message key='Select'/> -</option>                                              


                                        </select></td><!--set the office code to the plants selected-->
                                        <%} else if (Status.equals("Forwarded")) {%>
                                    <td class="text-right h5">
                                        <label for="submit_at" id='submit_at' ><fmt:message key='Forward To'/></label></td>
                                    <td width="20%">  <input type="text" name="forwardAtPlant" id="forwardAtPlant" style="width: 100%" value="<%=FORWARD_AT_DESC%>" class="form-control text-right" readonly="true" >
                                       <% }}else{%> 
                                        <td class="text-right h5">
                                       </td>
                                       <td width="20%">  </td>
                        ...
                        <tr>
                            <%  if (flag == 2 ||Status.equals("Forwarded")||Status.equals("Submitted")|| UserType.equals("Emp")) {%> 
                        ...
                        <div id="fileUpload" class="content_container" >
                            ...
                            <div id="FU_container" <% if ((Status == null) || (PODesc.equals(""))) {%> style="visibility: hidden;" <% }%> >
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>      <td class="col-md-1">
                                                 ...
                                                 <%  if (!selectedmodule.equals("PS")) {%>  
                                                 <td class="col-md-4">
                                                        <input type="button" value=<fmt:message key='Forward'/> name="Forward" id="Forward"  onclick="forwardButton()"
