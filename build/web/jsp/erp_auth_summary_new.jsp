                               ...
                               <div class="col-lg-12 col-md-12">
                                  <div class="table-responsive">
                                       ...
                                       %>   
                                         ...
                                         <div class="col-md-12 text-center"><h3><fmt:message key='Summary of Pending Invoices'/></h3></div>
                                        <table class="table">
                                            <thead>
                                                <tr class="success">                                                                                       
                                                    ...
                                                    <th class="text-center" id="hdr1" colspan="8"><fmt:message key='Pending with MSEDCL'/></th>                                                    
                                               </tr>
                                                <tr class="success">
                                                    <th colspan="5"></th>
                                                    <th colspan="2" class="text-center" headers="hdr1"><fmt:message key='Technical'/></th>                                                    
                                                    <th colspan="2" class="text-center" headers="hdr1"><fmt:message key='Pending For Payment'/></th>                                                                                                       
                                                    <th colspan="3" class="text-center" headers="hdr1"></th>
                                                 ...
                                                 <tr class="success">
                                                    ...
                                                    <th class="text-center" headers="hdr1"><fmt:message key='Pending less than 30 Days'/></th>                                                                                                       
                                                     <th class="text-center" headers="hdr1"><fmt:message key='Pending more than 30 Days'/></th>                                                    
                                                    <th class="text-center" headers="hdr1"><fmt:message key='Pending less than 30 Days'/></th>  
                                                     <th class="text-center" headers="hdr1"><fmt:message key='Paid Invoices'/></th>                                                    
                                                   <!-- <th class="text-center" headers="hdr1"><fmt:message key='Pending less than 30 Days'/></th>-->  
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table">
                                             <thead>
                                                ...
                                                <tr class="success">
                                                    <th colspan="5"></th>
                                                    <th class="text-center" headers="hdr1"><fmt:message key='Technical'/></th>                                                    
                                                    <th class="text-center" headers="hdr1"><fmt:message key='Pending For Payment'/></th>                                                                                                       
                                                    <th class="text-center" headers="hdr1"></th>
                                                    <th colspan="5"></th>
                                                </tr>
                                            </thead>
                                            <tbody>
