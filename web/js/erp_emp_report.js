function callReport() {
    ...
    if ((txtVendorNumber.indexOf("-")) > -1) {  
    txtVendorNumber = txtVendorNumber.substring(0, txtVendorNumber.indexOf("-"));
    }
...
function ReportVal(){
    var txtReportName = document.getElementById("txtReportName").value;
    if (txtReportName === "MSEDCLEmpReport") {
          var txtFrmDt = document.getElementById("txtFrmDt").value;
          var txtToDt = document.getElementById("txtToDt").value;
          ...
          var txtLocation = document.getElementById("txtLocation").value;
           ...
           if(trim(txtPONumber) === "" || trim(txtPONumber) ===null){
              alert("PO Number is Required. Type 'ALL' For All POs' report ");
              return false;
          }
  ...
  if (GivenDate > CurrentDate) {
    ...
    if (txtReportName === "Employee_Statistics_Reports") {
          var txtFrmDt = document.getElementById("txtFrmDt").value;
          var txtToDt = document.getElementById("txtToDt").value;
...
function getPOSearchList(){
  ...
  var type = "poList";
     JSON.parse(document.getElementById("poOptions").value); 
