<%-- 
    Document   : erp_vendor_legal_report
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper" >
                ...
                <%@ include file="navJs.jsp"%>
                    ...
                    <div >&nbsp;</div> <br><br><div class="col-md-12" align="center"><h3><fmt:message key='Vendor Reports'/></h3></div>
                    <div >&nbsp;</div>
                                                 ...
                                                 <th width="15%" class="text text-center"><fmt:message key='Report Name'/></th>
                                                            <td width="25%">
                                                                <select name="txtReportName" id="txtReportName" class="form-control" onchange="changeFields();">
                                                                    <option value="<%=ApplicationConstants.REPORT_VENDOR_LEGAL_SUBMITTED%>">Invoices Submitted Report</option>  
                                                                    <option value="<%=ApplicationConstants.REPORT_VENDOR_LEGAL_RETURNED%>">Invoices Returned Report</option>
                                    ...
                                    <tr>
                                         ...
                                         <td id="myDropdownTwo">
                                            <div class="autocomplete" style="width:300px;">
                                                <input type="text" name="txtInvNo" id="txtInvNo" style="width: 100%" value =ALL title="Type and search or use space-bar" placeholder=<fmt:message key='"Type and search or use space-bar"'/> class="form-control" />
                                              </div>        
                                          </td> 
