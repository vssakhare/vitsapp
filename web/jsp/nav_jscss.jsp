...
<link href="<%=ApplicationConstants.CSS_PATH%>emp.css"  rel="stylesheet" type="text/css"/>
<link href="css/jquery-ui.css?v=<%=System.getProperty("VERSION")%>" rel="stylesheet" />

<script src="assets/js/jquery-1.10.2.js?v=<%=System.getProperty("VERSION")%>"></script>
<script type="text/javascript" src="<%=ApplicationConstants.JS_PATH%>jquery-ui.js?v=<%=System.getProperty("VERSION")%>"></script>
